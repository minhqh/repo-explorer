...
const FUTURE_FEATURES: AIFeature[] = [
  { icon: '💬', title: 'Chat với Repository', desc: 'Đặt câu hỏi bằng ngôn ngữ tự nhiên về kiến trúc...' },
  { icon: '🛡️', title: 'Quét Lỗ Hổng', desc: 'AI tự động đọc cấu hình và cảnh báo thư viện lỗi thời.' },
  { icon: '💡', title: 'Gợi ý Tối ưu', desc: 'Phân tích các hàm phức tạp và đề xuất cách viết clean code.' },
  { icon: '📝', title: 'Tự động sinh Document', desc: 'Tạo tài liệu API dựa trên mã nguồn thực tế.' }
];

export default function AITabPlaceholder() {
  return (
    <div style={{ backgroundColor: '#f8faff', border: '1px dashed #0969da', borderRadius: '8px', padding: '40px 24px', textAlign: 'center' }}>
      ...
      <button style={{ marginTop: '40px', padding: '10px 24px', backgroundColor: '#ebf5ff', color: '#0969da', border: '1px solid #0969da', borderRadius: '6px', fontSize: '14px', fontWeight: 'bold', cursor: 'not-allowed', opacity: 0.8 }}>
        🚧 Đang xây dựng Model...
      </button>
    </div>
  );
