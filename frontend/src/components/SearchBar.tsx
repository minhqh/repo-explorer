  ...
  return (
    ...
    >
      ...
      <div style={{ display: 'flex', justifyContent: 'center', gap: '24px', color: '#57606a' }}>
        <label
          style={{
            ...
            color: !isPrivate ? '#24292e' : 'inherit',
          }}
        >
          <input
            type="radio"
      ...
      <form
        ...
        style={{ display: 'flex', gap: '12px', justifyContent: 'center', width: '100%' }}
      >
        <input
          type="text"
          value={url}
        ...
        <button
          ...
          style={{
            ...
            border: 'none',
            backgroundColor:
              isLoading || !url.trim() || (isPrivate && !token.trim()) ? '#ccc' : '#24292e',
            color: '#fff',
            cursor:
              isLoading || !url.trim() || (isPrivate && !token.trim()) ? 'not-allowed' : 'pointer',
            fontSize: '16px',
            fontWeight: 'bold',
